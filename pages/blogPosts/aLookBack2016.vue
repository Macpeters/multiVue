<template>
  <article>
    <h1>A Look Back - 2016</h1>
    <section>
      It's December 31, 2016, and changes are afoot.  It's time to take stock and see what I've been up to.  Follow
      me on Instagram for more pics:
    ...
    <section>
      ...
      <ul>
        ...
        <li>
          <h3>Visionary Skate art and Grafitti Workshop</h3>
            I took this workshop at <a href="https://www.cosm.org/" target="_blank">COSM</a> - led by 
            <a href="http://positivecreations.ca/" target="_blank">Chris Dyer</a>.  This was my first trip
    ...
    <section>
      ...
      <ul>
        ...
        <li>Jellyfish</li>
        <li>Oily Robot</li>
        <li>Grafitti Mouse</li>
        <li><a href="https://www.instagram.com/p/BHH1ATVgnfi/" target="_blank">Festival Spinners</a></li>
      </ul>
      <h4><a href="/art/skateboards" title="Paintings">Skateboard Decks</a></h4>
      <ul>
        <li>Mushroom Eye</li>
        <li>Psychedelic Bee</li>
        <li>Broken Robot</li>
        <li>Jerry Bear</li> 
      </ul>
    </section>
