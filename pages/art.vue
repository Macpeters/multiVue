...
import caughtInTheMusic from "../assets/fineArt/macpeters_caughtInTheMusic.jpg"; 
...
import caughtInTheMusic_thumb from "../assets/fineArt/thumbnails/macpeters_caughtInTheMusic.png"; 
